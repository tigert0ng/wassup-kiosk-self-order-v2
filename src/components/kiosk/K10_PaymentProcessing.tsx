...
export const K10_PaymentProcessing: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col p-4 sm:p-7 max-w-3xl mx-auto w-full">
      ...
      <div className="bg-white border-2 border-stone-200 rounded-3xl p-6 sm:p-8 shadow-md my-3 flex-1 flex flex-col items-center justify-center text-center relative overflow-hidden">
        {/* Countdown Badge */}
        ...
        <div className="relative p-4 rounded-3xl border-4 border-brand-green bg-white shadow-xl max-w-xs w-full mb-4">
          <img
            src={qrTransferUrl}
        ...
        {/* Bank Details Table */}
        <div className="w-full max-w-md bg-stone-50 border border-stone-200 rounded-2xl p-4 text-left text-xs space-y-2">
          ...
          <div className="flex items-center justify-between pt-1 border-t border-stone-200">
            ...
            <span className="font-display font-black text-base text-brand-green">
          ...
          <div className="flex items-center justify-between bg-white p-2.5 rounded-xl border border-stone-300">
            ...
            <button
              ...
              className="p-1.5 rounded-lg bg-stone-100 hover:bg-stone-200 text-slate-700 transition"
        ...
        {countdown === 0 && (
          <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-2xl w-full max-w-md flex items-center justify-between text-xs text-amber-800">
            <span>Mã QR đã hết hiệu lực (quá 60s).</span>
            <button
              type="button"
              onClick={() => setCountdown(60)}
              className="font-bold text-matte-black underline flex items-center gap-1"
            >
